...
.box{max-width:600px;margin:0 auto;background:#fff;border-radius:12px;padding:40px;border-top:4px solid #1a9e5c;box-shadow:0 2px 16px rgba(26,158,92,.10);}
...
.back{display:inline-block;margin-top:20px;padding:8px 20px;background:#1a9e5c;color:#fff;border-radius:8px;text-decoration:none;font-weight:600;font-size:.88rem;}
</style>
</head>
<body>
<div class="box">
